...
public class QuestManager : MonoBehaviour {
    ...
    void Start () {
        ...
        //Created some Quests
        inactive.Add(new Quest("QT01", "obtain", "PickUp", 1, "QT02").SetMessage("DisableGate", 0));
        inactive.Add(new Quest("QT02", "obtain", "PickUp2", 1, "QT03").SetMessage("DisableGate", 1));
        inactive.Add(new Quest("QT03", "obtain", "PickUp3", 1, "QT04").SetMessage("DisableGate", 2));
        inactive.Add(new Quest("QT04", "obtain", "FireBall", 1).SetMessage("ExitMaze", 3));
